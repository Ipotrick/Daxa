...
namespace daxa
{
    ...
    void Fsr2Context::upscale(CommandEncoder & command_list, UpscaleInfo const & info)
    {
        auto & impl = *as<ImplFsr2Context>();
    ...
    void ImplFsr2Context::upscale(CommandEncoder & command_list, UpscaleInfo const & upscale_info)
    {
        auto & impl_command_list = *command_list.as<ImplCommandEncoder>();
        auto & impl_device = *this->info.device.as<ImplDevice>();
        ...
        dispatch_description.commandList = ffxGetCommandEncoderVK(impl_command_list.vk_cmd_buffer);
