...
namespace daxa
{
    ...
    void ImplFsr2Context::upscale(CommandList & command_list, Fsr2UpscaleInfo const & info)
    {
        ...
        dispatch_description.color = ffxGetTextureResourceVK(
            ...
            static_cast<VkFormat>(color_slot.info.format), L"FSR2_InputColor");
        dispatch_description.depth = ffxGetTextureResourceVK(
            &fsr2_context, depth_slot.vk_image, depth_view_slot.vk_image_view,
            this->info.size_info.render_size_x, this->info.size_info.render_size_y,
            static_cast<VkFormat>(depth_slot.info.format), L"FSR2_InputDepth");
        dispatch_description.motionVectors = ffxGetTextureResourceVK(
            ...
            this->info.size_info.render_size_x, this->info.size_info.render_size_y,
            static_cast<VkFormat>(motion_vectors_slot.info.format), L"FSR2_InputMotionVectors");
        dispatch_description.exposure = ffxGetTextureResourceVK(&fsr2_context, nullptr, nullptr, 1, 1, VK_FORMAT_UNDEFINED, L"FSR2_InputExposure");
        ...
        dispatch_description.output = ffxGetTextureResourceVK(
            ...
            static_cast<VkFormat>(output_slot.info.format), L"FSR2_OutputUpscaledColor",
