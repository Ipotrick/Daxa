...
auto daxa_result_to_string(daxa_Result result) -> std::string_view
{
    switch (result)
    {
        ...
        case DAXA_RESULT_NO_COMPUTE_PIPELINE_BOUND: return "NO_COMPUTE_PIPELINE_BOUND";
        case DAXA_RESULT_NO_RASTER_PIPELINE_BOUND: return "NO_RASTER_PIPELINE_BOUND";
        case DAXA_RESULT_NO_RAYTRACING_PIPELINE_BOUND: return "NO_RAYTRACING_PIPELINE_BOUND";
        case DAXA_RESULT_NO_PIPELINE_BOUND: return "NO_PIPELINE_BOUND";
