...
namespace daxa {
        ...
        : device{ device }
    {
        ...
        auto vertexShaderModule = device->createShderModule({.glslSource = vertexGLSL, .stage = VK_SHADER_STAGE_VERTEX_BIT}).value();
        ...
        auto fragmentShaderModule = device->createShderModule({.glslSource = fragmentGLSL, .stage = VK_SHADER_STAGE_FRAGMENT_BIT}).value();
