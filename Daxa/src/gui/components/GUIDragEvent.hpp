	...
	namespace gui {
	  ...
	  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		template<> inline void onDragEvent(Manager& manager, Box& self, u32 id, u32 rootindex) 	{
			...
			Vec2 cursorPos = manager.coordSys.convertCoordSys<RenderSpace2d::Window, RenderSpace2d::Pixel>(manager.window->getCursorPositionVec());
			Vec2 cursorPrevPos = manager.coordSys.convertCoordSys<RenderSpace2d::Window, RenderSpace2d::Pixel>(manager.window->getPrevCursorPositionVec());
