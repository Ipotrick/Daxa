...
namespace daxa
{
    ...
    struct ITask
    {
        ...
        virtual void callback(TaskInterface const &) const {};
    };
...
#define DAXA_DECL_TASK_HEAD_END                                                                                  \
    ...
    virtual auto _shader_blob_size() const -> usize { return daxa::detail::shader_blob_size<AttachmentInfo>(); } \
    }                                                                                                            \
    ;
