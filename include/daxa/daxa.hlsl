...
typedef float2x2 f32mat2x2;
typedef float2x3 f32mat2x3;
typedef float2x4 f32mat2x4;
typedef double2 f64vec2;
typedef double2x2 f64mat2x2;
typedef double2x3 f64mat2x3;
typedef double2x4 f64mat2x4;
typedef float3 f32vec3;
typedef float3x2 f32mat3x2;
typedef float3x3 f32mat3x3;
typedef float3x4 f32mat3x4;
typedef double3 f64vec3;
typedef double3x2 f64mat3x2;
typedef double3x3 f64mat3x3;
typedef double3x4 f64mat3x4;
typedef float4 f32vec4;
typedef float4x2 f32mat4x2;
typedef float4x3 f32mat4x3;
typedef float4x4 f32mat4x4;
typedef double4 f64vec4;
typedef double4x2 f64mat4x2;
typedef double4x3 f64mat4x3;
typedef double4x4 f64mat4x4;
typedef float4 f32vec4;
typedef float4x2 f32mat4x2;
typedef float4x3 f32mat4x3;
typedef float4x4 f32mat4x4;
...
typedef int2x2 i32mat2x2;
typedef int2x3 i32mat2x3;
typedef int2x4 i32mat2x4;
typedef uint2 u32vec2;
typedef uint2x2 u32mat2x2;
typedef uint2x3 u32mat2x3;
typedef uint2x4 u32mat2x4;
typedef int3 i32vec3;
typedef int3x2 i32mat3x2;
typedef int3x3 i32mat3x3;
typedef int3x4 i32mat3x4;
typedef uint3 u32vec3;
typedef uint3x2 u32mat3x2;
typedef uint3x3 u32mat3x3;
typedef uint3x4 u32mat3x4;
typedef int4 i32vec4;
typedef int4x2 i32mat4x2;
typedef int4x3 i32mat4x3;
typedef int4x4 i32mat4x4;
typedef uint4 u32vec4;
typedef uint4x2 u32mat4x2;
typedef uint4x3 u32mat4x3;
typedef uint4x4 u32mat4x4;
...
namespace daxa
{
    ...
    template <typename T>
    Texture1D<T> get_Texture1D(ImageViewId image_id);
    template <typename T>
    Texture2D<T> get_Texture2D(ImageViewId image_id);
    template <typename T>
    Texture3D<T> get_Texture3D(ImageViewId image_id);
    template <typename T>
    Texture1DArray<T> get_Texture1DArray(ImageViewId image_id);
    template <typename T>
    Texture2DArray<T> get_Texture2DArray(ImageViewId image_id);
    template <typename T>
    RWTexture1D<T> get_RWTexture1D(ImageViewId image_id);
    template <typename T>
    RWTexture2D<T> get_RWTexture2D(ImageViewId image_id);
    template <typename T>
    RWTexture3D<T> get_RWTexture3D(ImageViewId image_id);
    ...
    ByteAddressBuffer get_ByteAddressBuffer(BufferId buffer_id)
    {
...
DAXA_DEFINE_GET_TEXTURE2D(u32)
DAXA_DEFINE_GET_TEXTURE2D(u32vec4)

DAXA_DEFINE_GET_RWTEXTURE2D(float)
DAXA_DEFINE_GET_RWTEXTURE2D(float2)
DAXA_DEFINE_GET_RWTEXTURE2D(float4)
DAXA_DEFINE_GET_RWTEXTURE2D(u32)
DAXA_DEFINE_GET_RWTEXTURE2D(u32vec4)

#define DAXA_REGISTER_STRUCT_GET_BUFFER DAXA_DEFINE_GET_STRUCTURED_BUFFER
