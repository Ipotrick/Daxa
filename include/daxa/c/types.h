...
typedef enum
{
    ...
    DAXA_RESULT_ERROR_CMD_LIST_SUBMIT_QUEUE_TYPE_MISMATCH = (1 << 30) + 65,
    DAXA_RESULT_ERROR_PRESENT_QUEUE_TYPE_MISMATCH = (1 << 30) + 66,
    DAXA_RESULT_ERROR_INVALID_QUEUE_TYPE = (1 << 30) + 67,
    ...
    DAXA_RESULT_ERROR_COMPUTE_TYPE_CMD_ON_TRANSFER_QUEUE_RECORDER = (1 << 30) + 72,
    DAXA_RESULT_ERROR_MAIN_TYPE_CMD_ON_TRANSFER_QUEUE_RECORDER = (1 << 30) + 73,
    DAXA_RESULT_ERROR_MAIN_TYPE_CMD_ON_COMPUTE_QUEUE_RECORDER = (1 << 30) + 74,
    ...
    DAXA_RESULT_ERROR_EXCEEDED_MAX_COMMAND_POOLS = (1 << 30) + 77,
    DAXA_RESULT_ERROR_CMD_LIST_ALREADY_COMPLETED = (1 << 30) + 78,
    DAXA_RESULT_ERROR_ADDRESS_BELONGS_TO_NO_BUFFER = (1 << 30) + 79,
    DAXA_RESULT_ERROR_WAYLAND_DISPLAY_IS_NULL = (1 << 30) + 80,
    DAXA_RESULT_ERROR_WAYLAND_SURFACE_IS_NULL = (1 << 30) + 81,
    DAXA_RESULT_ERROR_WAYLAND_FAILED_TO_CREATE_SURFACE = (1 << 30) + 82,
    DAXA_RESULT_ERROR_QUEUE_DOES_NOT_SUPPORT_SURFACE = (1 << 30) + 83,
    DAXA_RESULT_ERROR_INVALID_POINTER_PARAMETER = (1 << 30) + 84,
