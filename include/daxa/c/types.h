...
typedef enum
{
    ...
    DAXA_RESULT_EXEEDED_MAX_BUFFERS = (1 << 30) + 39,
    DAXA_RESULT_EXEEDED_MAX_IMAGES = (1 << 30) + 40,
    DAXA_RESULT_EXEEDED_MAX_IMAGE_VIEWS = (1 << 30) + 41,
    DAXA_RESULT_EXEEDED_MAX_SAMPLERS = (1 << 30) + 42,
