...
daxa_cmd_copy_buffer_to_buffer(daxa_CommandEncoder cmd_enc, daxa_BufferCopyInfo const * info);
DAXA_EXPORT DAXA_NO_DISCARD daxa_Result
daxa_cmd_copy_buffer_to_image(daxa_CommandEncoder cmd_enc, daxa_BufferImageCopyInfo const * info);
DAXA_EXPORT DAXA_NO_DISCARD daxa_Result
daxa_cmd_copy_image_to_buffer(daxa_CommandEncoder cmd_enc, daxa_ImageBufferCopyInfo const * info);
DAXA_EXPORT DAXA_NO_DISCARD daxa_Result
daxa_cmd_copy_image_to_image(daxa_CommandEncoder cmd_enc, daxa_ImageCopyInfo const * info);
DAXA_EXPORT DAXA_NO_DISCARD daxa_Result
daxa_cmd_blit_image_to_image(daxa_CommandEncoder cmd_enc, daxa_ImageBlitInfo const * info);

DAXA_EXPORT DAXA_NO_DISCARD daxa_Result
daxa_cmd_clear_buffer(daxa_CommandEncoder cmd_enc, daxa_BufferClearInfo const * info);
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_clear_image(daxa_CommandEncoder cmd_enc, daxa_ImageClearInfo const * info);
...
DAXA_EXPORT void
daxa_cmd_pipeline_barrier(daxa_CommandEncoder cmd_enc, daxa_MemoryBarrierInfo const * info);
/// @brief  Successive pipeline barrier calls are combined.
///         As soon as a non-pipeline barrier command is recorded, the currently recorded barriers are flushed with a vkCmdPipelineBarrier2 call.
/// @param info parameters.
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_pipeline_barrier_image_transition(daxa_CommandEncoder cmd_enc, daxa_ImageMemoryBarrierInfo const * info);
DAXA_EXPORT void
daxa_cmd_signal_event(daxa_CommandEncoder cmd_enc, daxa_EventSignalInfo const * info);
DAXA_EXPORT void
daxa_cmd_wait_events(daxa_CommandEncoder cmd_enc, daxa_EventWaitInfo const * infos, size_t info_count);
DAXA_EXPORT void
daxa_cmd_wait_event(daxa_CommandEncoder cmd_enc, daxa_EventWaitInfo const * info);
DAXA_EXPORT void
daxa_cmd_reset_event(daxa_CommandEncoder cmd_enc, daxa_ResetEventInfo const * info);

DAXA_EXPORT void
daxa_cmd_push_constant(daxa_CommandEncoder cmd_enc, void const * data, uint32_t size);
...
/// @param info parameters.
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_set_uniform_buffer(daxa_CommandEncoder cmd_enc, daxa_SetUniformBufferInfo const * info);
DAXA_EXPORT void
daxa_cmd_set_compute_pipeline(daxa_CommandEncoder cmd_enc, daxa_ComputePipeline pipeline);
DAXA_EXPORT void
daxa_cmd_set_raster_pipeline(daxa_CommandEncoder cmd_enc, daxa_RasterPipeline pipeline);
DAXA_EXPORT void
daxa_cmd_dispatch(daxa_CommandEncoder cmd_enc, uint32_t x, uint32_t y, uint32_t z);
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_dispatch_indirect(daxa_CommandEncoder cmd_enc, daxa_DispatchIndirectInfo const * info);
...
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_destroy_buffer_deferred(daxa_CommandEncoder cmd_enc, daxa_BufferId id);
...
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_destroy_image_deferred(daxa_CommandEncoder cmd_enc, daxa_ImageId id);
...
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_destroy_image_view_deferred(daxa_CommandEncoder cmd_enc, daxa_ImageViewId id);
...
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_destroy_sampler_deferred(daxa_CommandEncoder cmd_enc, daxa_SamplerId id);
...
/// @param info parameters.
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_begin_renderpass(daxa_CommandEncoder cmd_enc, daxa_RenderPassBeginInfo const * info);
/// @brief  Starts a renderpass scope akin to the dynamic rendering feature in vulkan.
///         Between the begin and end renderpass commands, the renderpass persists and draw-calls can be recorded.
DAXA_EXPORT void
daxa_cmd_end_renderpass(daxa_CommandEncoder cmd_enc);
DAXA_EXPORT void
daxa_cmd_set_viewport(daxa_CommandEncoder cmd_enc, VkViewport const * info);
DAXA_EXPORT void
daxa_cmd_set_scissor(daxa_CommandEncoder cmd_enc, VkRect2D const * info);
DAXA_EXPORT void
daxa_cmd_set_depth_bias(daxa_CommandEncoder cmd_enc, daxa_DepthBiasInfo const * info);
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_set_index_buffer(daxa_CommandEncoder cmd_enc, daxa_SetIndexBufferInfo const * info);

DAXA_EXPORT void
daxa_cmd_draw(daxa_CommandEncoder cmd_enc, daxa_DrawInfo const * info);
DAXA_EXPORT void
daxa_cmd_draw_indexed(daxa_CommandEncoder cmd_enc, daxa_DrawIndexedInfo const * info);
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_draw_indirect(daxa_CommandEncoder cmd_enc, daxa_DrawIndirectInfo const * info);
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_draw_indirect_count(daxa_CommandEncoder cmd_enc, daxa_DrawIndirectCountInfo const * info);
DAXA_EXPORT void
daxa_cmd_draw_mesh_tasks(daxa_CommandEncoder cmd_enc, uint32_t x, uint32_t y, uint32_t z);
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_draw_mesh_tasks_indirect(daxa_CommandEncoder cmd_enc, daxa_DrawMeshTasksIndirectInfo const * info);
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_draw_mesh_tasks_indirect_count(daxa_CommandEncoder cmd_enc, daxa_DrawMeshTasksIndirectCountInfo const * info);

DAXA_EXPORT void
daxa_cmd_write_timestamp(daxa_CommandEncoder cmd_enc, daxa_WriteTimestampInfo const * info);
DAXA_EXPORT void
daxa_cmd_reset_timestamps(daxa_CommandEncoder cmd_enc, daxa_ResetTimestampsInfo const * info);

DAXA_EXPORT void
daxa_cmd_begin_label(daxa_CommandEncoder cmd_enc, daxa_CommandLabelInfo const * info);
DAXA_EXPORT void
daxa_cmd_end_label(daxa_CommandEncoder cmd_enc);

// Is called by all other commands. Flushes internal pipeline barrier list to actual vulkan call.
DAXA_EXPORT void
daxa_cmd_flush_barriers(daxa_CommandEncoder cmd_enc);
DAXA_EXPORT DAXA_NO_DISCARD  daxa_Result
daxa_cmd_complete_current_commands(daxa_CommandEncoder cmd_enc, daxa_ExecutableCommands * out_execble_cmds);
DAXA_EXPORT daxa_CommandEncoderInfo const *
daxa_cmd_info(daxa_CommandEncoder cmd_enc);
DAXA_EXPORT VkCommandBuffer
daxa_cmd_get_vk_command_buffer(daxa_CommandEncoder cmd_enc);
DAXA_EXPORT VkCommandPool
daxa_cmd_get_vk_command_pool(daxa_CommandEncoder cmd_enc);
DAXA_EXPORT void
daxa_destroy_command_encoder(daxa_CommandEncoder cmd_enc);

DAXA_EXPORT uint64_t
daxa_executable_commands_inc_refcnt(daxa_ExecutableCommands executable_commands);
DAXA_EXPORT uint64_t
daxa_executable_commands_dec_refcnt(daxa_ExecutableCommands executable_commands);

// TODO(command encoder):
// * implement all zero ref callbacks
// * implement cpp wrapper
// * fix samples
// * fix lifetimes and ref counting
// * add command buffer naming
// * test full resetting for command pools
// * add DAXA_NO_DISCARD to all returning functions
