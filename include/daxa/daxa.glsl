...
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_FLOAT(image2DRect)
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_FLOAT(imageCubeArray)
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_FLOAT(image2DMS)
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_FLOAT(image2DMSArray)
...
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_INT(iimage2DRect)
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_INT(iimageCubeArray)
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_INT(iimage2DMS)
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_INT(iimage2DMSArray)
...
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_UINT(uimage2DRect)
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_UINT(uimageCubeArray)
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_UINT(uimage2DMS)
// DAXA_REGISTER_READ_WRITE_IMAGE_TYPE_UINT(uimage2DMSArray)
...
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(texture2DRect)
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(textureCubeArray)
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(texture2DMS)
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(texture2DMSArray)
...
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(itexture2DRect)
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(itextureCubeArray)
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(itexture2DMS)
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(itexture2DMSArray)
...
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(utexture2DRect)
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(utextureCubeArray)
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(utexture2DMS)
// DAXA_REGISTER_READ_ONLY_IMAGE_TYPE(utexture2DMSArray)
...
// DAXA_REGISTER_SAMPLER_TYPE(sampler2DRect)
// DAXA_REGISTER_SAMPLER_TYPE(samplerCubeArray)
// DAXA_REGISTER_SAMPLER_TYPE(sampler2DMS)
// DAXA_REGISTER_SAMPLER_TYPE(sampler2DMSArray)
...
// DAXA_REGISTER_SAMPLER_TYPE(isampler2DRect)
// DAXA_REGISTER_SAMPLER_TYPE(isamplerCubeArray)
// DAXA_REGISTER_SAMPLER_TYPE(isampler2DMS)
// DAXA_REGISTER_SAMPLER_TYPE(isampler2DMSArray)
...
// DAXA_REGISTER_SAMPLER_TYPE(usampler2DRect)
// DAXA_REGISTER_SAMPLER_TYPE(usamplerCubeArray)
// DAXA_REGISTER_SAMPLER_TYPE(usampler2DMS)
// DAXA_REGISTER_SAMPLER_TYPE(usampler2DMSArray)
...
// DAXA_REGISTER_SAMPLER_TYPE(sampler2DRectShadow)
// DAXA_REGISTER_SAMPLER_TYPE(samplerCubeArrayShadow)
