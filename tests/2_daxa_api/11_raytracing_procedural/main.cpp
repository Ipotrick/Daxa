        ...
        struct App : AppWindow<App>
        {
            ...
            void initialize()
            {
                ...
                *device.get_host_address_as<daxa_rowmaj_f32mat3x4>(transform_buffer).value() = daxa_rowmaj_f32mat3x4{
                ...
                // AABB Geometry Info:
                auto geometries = std::array{daxa::BlasAabbGeometryInfo{
                        .data = device.get_device_address(aabb_buffer).value(),
                        .stride = sizeof(daxa_f32vec3) * 2,
                        .count = 1, // Ignored in get_acceleration_structure_build_sizes.
                ...
                *device.get_host_address_as<daxa_BlasInstanceData>(blas_instances_buffer).value() = daxa_BlasInstanceData{
                    ...
                    .flags = DAXA_GEOMETRY_INSTANCE_FORCE_OPAQUE, // Not used.
                ...
                pipeline_manager = daxa::PipelineManager{daxa::PipelineManagerInfo{
                    ...
                    .shader_compile_options = {
                        .root_paths = {
                            ...
                            "tests/2_daxa_api/11_raytracing_procedural/shaders",
                        },
                    },
                }};
