...
DAXA_DECL_RASTER_TASK_HEAD_BEGIN(DrawToSwapchainH) 
// The line below declares an image attachment.
...
// The line below declares a buffer attachment.
// The task buffer use is VERTEX_SHADER::READ (stage = VERTEX_SHADER, access = READ), 
//   the shader pointer type is daxa_BufferPtr(MyVertex) and the name is vertices.
DAXA_TH_BUFFER_PTR(VERTEX_SHADER::READ, daxa_BufferPtr(MyVertex), vertices)
