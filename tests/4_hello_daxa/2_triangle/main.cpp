...
void draw_to_swapchain_task(daxa::Device & device, daxa::CommandEncoder & encoder, std::shared_ptr<daxa::RasterPipeline> & pipeline, daxa::ImageId swapchain_image, daxa::BufferId buffer_id, daxa::u32 width, daxa::u32 height);
